		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="idEstadoUsuario" title="${message(code: 'usuario.idEstadoUsuario.label', default: 'Id Estado Usuario')}" />
					
						<g:sortableColumn property="eliminado" title="${message(code: 'usuario.eliminado.label', default: 'Eliminado')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "idEstadoUsuario")}</td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "eliminado")}</td>
